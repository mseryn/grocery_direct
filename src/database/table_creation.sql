...
(
    ...
    constraint supplier_to_product_fk foreign key (supplier_id) references person(id),
...
(
    ...
    constraint state_to_product_fk  foreign key (state_id)   references state_codes(id),
